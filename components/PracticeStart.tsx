...
export const PracticeStart: React.FC<PracticeStartProps> = ({ 
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 flex flex-col items-center animate-fade-in-up">
      <div className="bg-white rounded-3xl p-12 border border-white shadow-[0_10px_30px_rgba(90,85,120,0.15)] mb-6 flex flex-col items-center w-full max-w-2xl">
